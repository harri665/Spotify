...
async function main() {
  // User provided token (appears to be sp_dc cookie, but let's test it)
  const accessToken = 'AQBbWMvOJE6ogmn-_L67o1gWzCOSaJGuYrYCxiedBP5-60GtsxHxK7oI-V5w-DzFcR1sW5BcI9gxWV0rSUV2VNB6rhlqkPbD_BGjDM-APb49SFUeDP9sL1qLHlCvfciPUlrD2d7yLNyyYMcbyE6_sv34emaRyZf4';
  
  console.log('📝 Note: This appears to be an sp_dc cookie value rather than a Bearer token');
  console.log('� Spotify access tokens typically start with "BQ" and are longer');
  console.log('⚠️  Testing anyway in case this works...\n');
